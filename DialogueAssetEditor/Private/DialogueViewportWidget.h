...
class DIALOGUEASSETEDITOR_API SDialogueViewportWidget : public SCompoundWidget
{
...
public:
	...
	void Construct(const FArguments& InArgs, TSharedPtr<FDialogueAssetEditor> InDialogueEditor);
	...
	TWeakPtr<FDialogueAssetEditor> DialogueEditorPtr;
...
private:	
	...
	TSharedPtr<FDialogueZoomLevelsContainer> ZoomLevels;
