...
class DIALOGUEASSETEDITOR_API SDialogueNodeWidget : public SCompoundWidget
{
private:
	...
	SLATE_ARGUMENT(SDialogueViewportWidget*, DialogueViewportWidget)
...
private:
	...
	int32 NodeIndex;
	UDialogue* Dialogue;
	SDialogueViewportWidget* DialogueViewportWidget;
};
